...
- [Lab 1: Environment readiness](../lab01-environment/README.md): understand
...
- [Lab 2: Classification and stewardship](../lab02-classification/README.md): become familiar
...
LAB 3 TECHNICAL CHECKS COMPLETE. Return to labs/core/lab03-modeling-quality/README.md for interpretation and deliverables.
```
...
The [synthetic records](../lab02-classification/lab2_seed.sql) provide the source data.
...
[detailed order mart](../../../dbt/it4065c_platform/models/marts/lab3/order_detail_mart.sql)
...
cp -i labs/core/lab03-modeling-quality/lab3_guided_test.sql dbt/it4065c_platform/student_tests/lab3_guided_daily_orders.sql
```
...
![Annotated Nano starter: paste the SQL in the editing area, check the violation condition, recognize the unsaved-change asterisk, and save with Ctrl+O, Enter, then exit with Ctrl+X.](../../../sample_screenshots/lab3-b2-nano-guide.svg)

This annotated reference shows the SQL starter and editor controls. Copy SQL
from the text block, then adapt it as directed below. The illustration is not
execution evidence and does not establish that a test passed.
...
See the Lab 3 [sample submission](Lab3_Sample_Submission_README.md).
See Lab 3 [sample submission template](labs/core/lab03-modeling-quality/Lab3_Sample_Submission_README.md).
See the Lab 3 [sample submission](Lab3_Sample_Submission_README.md) for an example of the expected structure, evidence and level of detail.
