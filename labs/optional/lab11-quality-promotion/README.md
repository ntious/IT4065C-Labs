...
Complete [Lab 3](../../core/lab03-modeling-quality/README.md) and [optional Lab 10](../lab10-catalog-ingestion/README.md). Use the same Ubuntu environment and run commands from the repository root. A reporting pipeline must preserve its last
