...
[Lab 3](../../core/lab03-modeling-quality/README.md) introduces reporting models; [Lab 4](../../core/lab04-lineage-lifecycle/README.md) introduces stored copies.
...
LAB 9 TECHNICAL CHECKS COMPLETE. Return to labs/optional/lab09-infrastructure/README.md for interpretation and deliverables.
```
...
```bash
cp -i labs/optional/lab09-infrastructure/infrastructure.sql .local/snapshot-experiment.sql
```
