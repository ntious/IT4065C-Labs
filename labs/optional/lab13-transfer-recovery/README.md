...
Complete [Lab 4](../../core/lab04-lineage-lifecycle/README.md) and the [infrastructure comparison](../../../docs/module_learning_map.md). Read [optional setup](../infrastructure_setup.md).
