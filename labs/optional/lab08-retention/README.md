...
[Lab 4](../../core/lab04-lineage-lifecycle/README.md) introduces downstream copies; [Lab 2](../../core/lab02-classification/README.md) introduces retention decisions.
...
LAB 8 TECHNICAL CHECKS COMPLETE. Return to labs/optional/lab08-retention/README.md for interpretation and deliverables.
```
...
```bash
cp -i labs/optional/lab08-retention/retention.sql .local/retention-experiment.sql
```
