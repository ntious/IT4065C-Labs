...
Select them for available time and student interest. Server auditing, actual
multi-instance administration and verified transport encryption remain practical
coverage gaps, as recorded in the syllabus crosswalk. They need developed and tested
supervised activities or an approved syllabus substitution.
