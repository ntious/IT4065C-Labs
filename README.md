...
Use an **individual Ubuntu 22.04/24.04 VM or Ubuntu in WSL2**. Open its Ubuntu terminal:
...
**8–9** for additional lifecycle/infrastructure experiments. A `PASS` message
